        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-xs text-gray-500 mb-3">
              Expected keys: <code className="bg-gray-100 px-1 rounded">url</code>, 
              <code className="bg-gray-100 px-1 rounded ml-1">method</code> (optional), 
              <code className="bg-gray-100 px-1 rounded ml-1">headers</code> (optional), 
              <code className="bg-gray-100 px-1 rounded ml-1">body</code> (optional)
            </p>
            <InputEditor 
              value={input} 
              onChange={setInput}
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
              <label className="flex items-center space-x-2 cursor-pointer">
                ...
                <span className="text-gray-500 text-xs">Show request/response details</span>
              </label>
              ...
              <label className="flex items-center space-x-2 cursor-pointer">
                ...
                <span className="text-gray-500 text-xs">Ignore SSL certificate errors</span>
              </label>
              ...
              <label className="flex items-center space-x-2 cursor-pointer">
                ...
                <span className="text-gray-500 text-xs">Include response headers in output</span>
              </label>
              ...
              <label className="flex items-center space-x-2 cursor-pointer">
                ...
                <span className="text-gray-500 text-xs">Silent mode, no progress bar</span>
              </label>
              ...
              <label className="flex items-center space-x-2 cursor-pointer">
                ...
                <span className="text-gray-500 text-xs">Follow HTTP redirects automatically</span>
              </label>
            </div>
          </div>
          ...
          {output.full && (
            <div className="text-xs text-gray-600 bg-blue-50 p-3 rounded-lg border border-blue-200">
              ...
              <ul className="space-y-1">
                ...
                <li>• Click "Copy Full Command" to get the complete unmasked command</li>
                <li>• Add <code className="bg-blue-100 px-1 rounded">-i</code> to include response headers</li>
                <li>• Add <code className="bg-blue-100 px-1 rounded">-v</code> for verbose output</li>
